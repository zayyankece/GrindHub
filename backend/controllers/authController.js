...
exports.getGroups = async(req, res) => {
  ...
  try{
    const existingGroups = await db.query('SELECT gc.groupname FROM groupmembers gm JOIN groupcollections gc ON gm.groupid = gc.groupid WHERE gm.userid = $1', [userid])
